...
return [
    ...
    'explore_btn'       => 'Explorar serviços',
    'quick_facts'       => 'Dados rápidos',
    'total_consulting'  => 'Consultorias ativas',
    'total_equipment'   => 'Categorias de equipamento',
    'all_services_label'=> 'Todos os serviços',
    'all_services_title'=> 'Soluções para geologia, engenharia e operação',
    'all_services_desc' => 'Da análise geológica à seleção de equipamentos, estruturamos soluções técnicas para empresas em fase de arranque, expansão e otimização operacional.',
    'from_label'        => 'Desde',
