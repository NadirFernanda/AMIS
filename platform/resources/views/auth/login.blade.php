        ...
        <div class="hidden lg:flex lg:w-1/2 xl:w-3/5 bg-[#1a3a5c] relative overflow-hidden flex-col justify-between p-12">
            ...
            <div class="relative">
                ...
                <p class="text-slate-300 text-lg leading-relaxed mb-10 max-w-md">
                    Aceda aos seus projetos, materiais de formação e comunique diretamente com a nossa equipa de especialistas.
                </p>
                <div class="space-y-4">
                    @foreach([
                        ['Acompanhe o progresso dos seus projetos em tempo real', 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
