<x-layouts.public>
    ...
    <x-slot name="description">Portfólio de projectos da AMIS — consultoria mineira, formação certificada e equipamentos em Angola e África Austral.</x-slot>
    ...
    <div class="relative bg-[#1a3a5c] py-28 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 class="text-4xl sm:text-5xl font-extrabold text-white mt-2">Os Nossos Projectos</h1>
            ...
            <div class="flex flex-wrap gap-8 mt-10">
                @foreach([$projectos->count() . ' Projectos', '4 Países', '200+ Profissionais Formados', '100% Taxa de Satisfação'] as $stat)
    ...
    <section class="py-16 bg-[#1a3a5c]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-2xl sm:text-3xl font-extrabold text-white mb-4">O seu projecto pode ser o próximo</h2>
