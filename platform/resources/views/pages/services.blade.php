<x-layouts.public>
    ...
    <div class="relative bg-[#1a3a5c] py-28 overflow-hidden">
        <div class="absolute inset-0">
            <img src="/img/9.jpeg" alt="" class="w-full h-full object-cover opacity-25">
    ...
    <section id="consultoria" class="py-24 bg-white scroll-mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {{-- Consultoria visual banner --}}
            <div class="relative rounded-3xl overflow-hidden mb-16 h-48 sm:h-56">
                <img src="/img/4.jpeg" alt="Consultoria Técnica" class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-r from-[#1a3a5c]/90 to-[#1a3a5c]/30"></div>
                <div class="absolute inset-0 flex items-center px-4 sm:px-10">
                    <div class="flex items-center gap-3 sm:gap-4">
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 rounded-2xl flex items-center justify-center shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-slate-300 text-sm mt-1 max-w-lg hidden sm:block">{{ __('services.cons_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="equipamentos" class="py-24 bg-slate-50 scroll-mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {{-- Equipment visual banner --}}
            <div class="relative rounded-3xl overflow-hidden mb-16 h-48 sm:h-56">
                <img src="/img/6.jpeg" alt="Equipamentos" class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-r from-[#0d8a7d]/90 to-[#0d8a7d]/30"></div>
                <div class="absolute inset-0 flex items-center px-4 sm:px-10">
                    <div class="flex items-center gap-3 sm:gap-4">
                        <div class="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 rounded-2xl flex items-center justify-center shrink-0">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            ...
                            <p class="text-slate-200 text-sm mt-1 max-w-lg hidden sm:block">{{ __('services.equip_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
