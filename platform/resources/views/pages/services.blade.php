<x-layouts.public>
    ...
    <section id="consultoria" class="py-24 bg-white scroll-mt-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative rounded-3xl overflow-hidden mb-16 h-56">
                ...
                <div class="absolute inset-0 flex items-center px-10">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-2xl font-extrabold text-white">{{ __('services.cons_title') }}</h2>
                            <p class="text-slate-300 text-sm mt-1 max-w-lg">{{ __('services.cons_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="absolute inset-0 flex items-center px-10">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-2xl font-extrabold text-white">{{ __('services.equip_title') }}</h2>
                            <p class="text-slate-200 text-sm mt-1 max-w-lg">{{ __('services.equip_desc') }}</p>
                        </div>
                    </div>
                </div>
            </div>
