<x-layouts.admin>
    <x-slot name="title">Novo Projecto</x-slot>
    ...
    <div class="flex items-center gap-3 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-extrabold text-[#0f2640]">Novo Projecto</h1>
    ...
    <form method="POST" action="{{ route('admin.projectos.store') }}" class="space-y-6 max-w-3xl">
        @csrf
