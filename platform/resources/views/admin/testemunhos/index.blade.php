<x-layouts.admin>
    ...
    <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex items-center gap-3">
            ...
            @endif
            <a href="{{ route('admin.testemunhos.create') }}"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 hover:shadow-md transition-shadow relative">
            ...
            <div class="flex items-start justify-between gap-2 mb-3">
                ...
                <form method="POST" action="{{ route('admin.testemunhos.toggle', $d) }}">
                    @csrf @method('PATCH')
                    <button type="submit"
            ...
            <div class="flex items-center gap-2 mt-4 pt-3 border-t border-slate-100">
                <a href="{{ route('admin.testemunhos.edit', $d) }}"
                ...
                <form method="POST" action="{{ route('admin.testemunhos.destroy', $d) }}"
        ...
        <div class="col-span-3 bg-white rounded-2xl border border-slate-200 py-16 text-center text-slate-400">
            <p class="text-sm">Sem testemunhos. <a href="{{ route('admin.testemunhos.create') }}" class="text-[#c9922a] hover:underline">Adicionar o primeiro</a>.</p>
        </div>
        @endforelse
    </div>

    @if($testemunhos->hasPages())
    <div class="mt-6">{{ $testemunhos->links() }}</div>
    @endif
</x-layouts.admin>
