<x-layouts.admin>
    <x-slot name="title">Editar Membro</x-slot>
    ...
    <div class="flex items-center gap-3 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-extrabold text-[#0f2640]">Editar: {{ $membro->nome }}</h1>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('admin.equipa.update', $membro) }}" class="space-y-6 max-w-3xl">
        @csrf @method('PUT')
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="nome" value="{{ old('nome', $membro->nome) }}" required
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                <div x-data="{ cor: '{{ old('cor', $membro->cor) }}' }">
                ...
                <div>
                    ...
                    <input type="number" name="ordem" value="{{ old('ordem', $membro->ordem) }}" min="0"
                           class="w-full border border-slate-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0f2640]/20 focus:border-[#0f2640]">
                </div>
                <div class="pt-1">
