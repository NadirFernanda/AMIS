<x-layouts.cliente>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
        @foreach([
            ...
            ['Fornecedores Contactados', '0', '#c9922a', 'M3 21v-4a4 4 0 014-4h10a4 4 0 014 4v4M12 13a4 4 0 100-8 4 4 0 000 8z'],
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6">
            <h2 class="text-base font-bold text-[#1a3a5c] mb-5">Acções Rápidas</h2>
            <div class="space-y-3">
                @foreach([
                    ...
                    ['Ver Fornecedores', route('fornecedores'), '#c9922a', 'M3 21v-4a4 4 0 014-4h10a4 4 0 014 4v4M12 13a4 4 0 100-8 4 4 0 000 8z'],
