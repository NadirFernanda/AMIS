...
$projectos = [
    [
        ...
        'tipo'      => 'consultoria',
        'descricao' => 'Elaboração do plano de lavra e optimização do sequenciamento de produção para uma mina de granito industrial, com levantamento topográfico e modelagem 3D do jazigo.',
    ...
    [
        ...
        'local'     => 'Huambo, Angola',
        'tipo'      => 'formacao',
        'descricao' => 'Formação prática em operação de escavadoras, bulldozers e camiões de grande porte para o sector mineiro, com componente teórica de manutenção preventiva.',
